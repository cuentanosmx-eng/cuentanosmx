...
<div class="cnmx-users-page">
    <div class="cnmx-users-container">
        ...
        <div class="cnmx-users-card">
            ...
            <h1 class="cnmx-users-title">Iniciar sesión</h1>
            <p class="cnmx-users-subtitle">¡Nos alegra verte de nuevo!</p>
            
            <div class="cnmx-social-buttons">
                <a href="<?php echo home_url('/wp-login.php?loginGoogle=1'); ?>" class="cnmx-social-btn cnmx-btn-google">
                ...
                <a href="<?php echo home_url('/wp-login.php?loginFacebook=1'); ?>" class="cnmx-social-btn cnmx-btn-facebook">
            ...
            <form id="cnmx-user-login-form" class="cnmx-auth-form">
            ...
            <p class="cnmx-users-footer">
                ¿No tienes cuenta? <a href="<?php echo home_url('/registro'); ?>">Regístrate gratis</a>
            </p>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo admin_url('admin-ajax.php'); ?>?action=cnmx_login', {
            method: 'POST',

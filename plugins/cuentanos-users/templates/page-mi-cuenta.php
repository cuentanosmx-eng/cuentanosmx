...
<div class="cnmx-users-page">
    <div class="cnmx-users-container">
        <div class="cnmx-users-card">
            ...
            <h1 class="cnmx-users-title">👋 ¡Bienvenido de nuevo!</h1>
            <p class="cnmx-users-subtitle">Ingresa a tu cuenta</p>
            ...
            <div class="cnmx-social-login">
                <p>o continúa con</p>
                <div class="cnmx-social-buttons">
                    <button class="cnmx-social-btn google">
